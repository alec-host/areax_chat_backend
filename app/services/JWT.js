...
console.log(JWT_ISSUER,' ggggggggggggggggggggggggggggggggggggggggggggggg ' ,JWT_AUDIENCE);
...
module.exports.accessToken = (data) => {
  ...
  //return token;
  return signAccess({ email: data.email, reference_number: data.reference_number });
};
